 ...
 * generated in the wscalc.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sub_QNAME = new QName("http://ws.WsCalc", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://ws.WsCalc", "subResponse");
    private final static QName _Add_QNAME = new QName("http://ws.WsCalc", "add");
    private final static QName _Div_QNAME = new QName("http://ws.WsCalc", "div");
    private final static QName _DivResponse_QNAME = new QName("http://ws.WsCalc", "divResponse");
    private final static QName _Mul_QNAME = new QName("http://ws.WsCalc", "mul");
    private final static QName _MulResponse_QNAME = new QName("http://ws.WsCalc", "mulResponse");
    private final static QName _AddResponse_QNAME = new QName("http://ws.WsCalc", "addResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wscalc.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.WsCalc", name = "addResponse")
